...
using namespace std;
    ...
    void add_account(const string &full_name, const string &age, const char &gender, const string &cellphone_num, const string &email, const string &address, const int &acc_number, const int &balance, const string &pin_number){
        ...
        if (outFile.is_open()) {
            outFile << acc_number << endl << " " << full_name << endl << age << " " << gender << " " << cellphone_num << " " << email << " " << balance << " " << pin_number << endl << address << endl;
            outFile.close();
        } else {
                ...
                if (tempFile.is_open()) {
                    while (inFile >> storedAcc_number) {
                        ...
                        getline(inFile >> ws, storedAddress);
                            ...
                            tempFile << storedAcc_number << endl << " " << storedFull_name << endl << storedAge << " " << storedGender << " " << storedCellphone_num << " " << storedEmail << " " << storedBalance << " " << storedPin_number << endl << storedAddress << endl;
    ...
    void remove_account(const int &acc_number, const string &warn){
...
bool pin_pass(string &pin, const &f_acc_number) {
    ifstream inFile("data.txt");
    if (inFile.is_open()) {
        int storedAcc_number, storedBalance;
        string storedFull_name, storedCellphone_num, storedEmail, storedAddress, storedPin_number, storedAge;
